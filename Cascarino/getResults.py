...
def create_random_population(section_1_list: list, section_2_list: list, percentage: int):
    n_section_1 = int((percentage/100) * len(section_1_list))
    n_section_2 = int((percentage/100) * len(section_2_list))
    n = n_section_1 * n_section_2
    print(n)
    population = []
    for _ in range(n):
        population.append([random_section(section_1_list), random_section(section_2_list)])
...
population = create_random_population(section_1_list=column_list , section_2_list= beam_list, percentage=33)
